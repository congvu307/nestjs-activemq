...
exports.ActiveMQHandler = void 0;
const common_1 = require("@nestjs/common");
const stompit = require("stompit");
let ActiveMQHandler = class ActiveMQHandler {
    constructor(options) {
        this.client = null;
    ...
    sendMessage(messageToPublish, queue) {
        const sendHeaders = {
            destination: queue,
...
ActiveMQHandler = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject("ACTIVEMQ_CONFIG")),
    __metadata("design:paramtypes", [Object])
], ActiveMQHandler);
exports.ActiveMQHandler = ActiveMQHandler;
